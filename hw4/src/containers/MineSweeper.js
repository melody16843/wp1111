...
const MineSweeper = () => {
    ...
    return (
        <div className='mineSweeper'>
            ...
            {startGame==true ? <Board boardSize={10} mineNum={10} backToHome = {backToHomeOnClick}></Board> : <HomePage startGameOnClick = {startGameOnClick}></HomePage>}
